...
const TWEAKS_STYLE = `
  .twk-toggle-btn{position:fixed;right:16px;bottom:16px;z-index:2147483645;
    appearance:none;border:.5px solid rgba(0,0,0,.2);background:rgba(250,249,247,.92);
    color:#29261b;border-radius:999px;padding:8px 14px;font:600 11px/1 ui-sans-serif,system-ui,-apple-system,sans-serif;
    letter-spacing:.04em;cursor:pointer;box-shadow:0 4px 14px rgba(0,0,0,.18);backdrop-filter:blur(12px)}
  .twk-toggle-btn:hover{background:rgba(255,255,255,1)}
...
const STORAGE_KEY = 'nasha-tweaks-v1';
